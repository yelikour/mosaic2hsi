...
def shift_back(inputs,step=2):          # input [bs,31,256,310]  output [bs, 31, 256, 256]
...
class MST_Plus_Plus(nn.Module):
    def __init__(self, in_channels=3, out_channels=31, n_feat=31, stage=3):
        ...
        self.fution = nn.Conv2d(31, 31, 1, padding=0, bias=True)
    ...
    def initial_x(self, y):
        """
        :param y: [b,1,256,310]
        :param Phi: [b,31,256,310]
        :return: z: [b,31,256,310]
        """
        nC, step = 31, 2
        bs, row, col = y.shape
