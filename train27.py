...
import argparse
from model import MultiscaleNet, ParallelMultiscaleNet, ResidualNet, MST_Plus_Plus, MST3, MST27
from dataset27 import MyDataSet
...
def main():
    ...
    parser.add_argument('--model', type=str, required=True, choices=['MST27'],
                        help='The model to train: MST27')
