...
def main():
    ...
    dataset = MyDataSet(dataPath=train_data_dir, gtPath=gt_data_dir, resize=(512, 512))
    ...
    for fold, (train_idx, val_idx) in enumerate(kfold.split(dataset)):
        ...
        model_path = f'/home/wangruozhang/mosaic2hsi/trainedWeights/{args.model}_fold{fold + 1}_CAVEself_Weights_trained.pth'
